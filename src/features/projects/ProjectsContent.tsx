      ...
      <div className="pt-20 pb-16 px-4 md:px-6">
        ...
        <section className="flex items-center justify-center min-h-[50vh] py-20 md:py-32">
          <div className="max-w-6xl w-full text-center">
            <div className="mb-8">
              <span aria-hidden="true" className="text-white/40 font-montserrat text-sm tracking-widest">PORTFOLIO</span>
            </div>
        ...
        <section className="max-w-7xl mx-auto py-20 md:py-32">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            {PROJECT_DATA.map((project) => (
              ...
              <span aria-hidden="true" className="text-white/40 font-montserrat text-xs tracking-widest">
        ...
        <section className="py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              <span aria-hidden="true" className="text-white/40 font-montserrat text-sm tracking-widest">LET&apos;S CONNECT</span>
            </div>
